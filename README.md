...
Tokens are use to authenticate users

- [ ] What steps can you take in your web apps to keep your data secure?

You can use protected routes and require authentication before accessing this data thats protects

- [ ] Describe how web servers work.

Web servers store, process, and deliver web pages to clients. Uses HTTP to provide the files that form web pages to users in resonse to a users request
